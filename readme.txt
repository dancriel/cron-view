...
However, do not hold your breath! Development for this plugin will be as and when I need it, or when someone submits a handy patch. I'm definitely open to co-development on this one, so if you want to join in then [contact me](http://www.simonwheatley.co.uk/contact-me/).
...
1. Unzip it
1. Upload `cron-gui.zip` directory to your WordPress Plugin directory
...
1. Showing the Cron view screen in the admin area
